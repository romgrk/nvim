...
hi def link moonGlobal Constant
...
syn match moonCommentSection /\v-*\s*\zs\w+\s*:/ contained
hi def link moonCommentSection PreProc

syn match moonComment /--.*/ contains=@Spell,moonTodo,moonCommentSection
...
syn match moonDotAccess /\.\@<=[a-z_]\w\+/ contains=@moonIdentifier
hi def link moonDotAccess Function

syn match moonBarAccess /\\\@<=[a-z_]\w\+/ contains=@moonIdentifier
hi def link moonBarAccess Class
...
"hi! def link moonBlock   moonDelimiter
"hi! def link moonBracket moonDelimiter
hi! def link moonCurly   moonDelimiter
"hi! def link moonParen   moonDelimiter
syn match moonDelimiter /[(){}]/ display
hi! def link moonDelimiter Delimiter
...
\                              moonDotAccess,moonBarAccess,
\                              moonDelimiter,moonCommentSection,moonCurlies,
