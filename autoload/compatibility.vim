...
function! compatibility#Disable() abort
  if &compatible
    set nocompatible
    call error#Warn('Vi compatibility mode was on.')
    call error#Warn('Maktaba does not support vi compatibility; it has been turned off.')
    call error#Warn(':set nocompatible early in your vimrc to avoid this message.')
    call error#Warn('See :help compatible for details.')
  endif
endfunction
