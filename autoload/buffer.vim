...
function! buffer#Overwrite(startline, endline, lines) abort
  call ensure#IsNumber(a:startline)
  call ensure#IsNumber(a:endline)
  call ensure#IsList(a:lines)
  ...
  if has('python')
    ...
    " implementation.
    call python#ImportModule(s:plugin, 'maktaba')
...
function! buffer#Substitute(pattern, ...) abort
