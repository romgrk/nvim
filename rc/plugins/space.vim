...
let space_no_character_movements = 1

"Disable <Space> for search commands >
let space_no_search = 0
...
"like snipmate.vim) >
let space_disable_select_mode = 1
