...
call hi#('BufferMod',        ['#1f1f1f',       '#4e4e48', ''])
call hi#('BufferCurrentMod', [theme.hl,        theme.bg,  ''])
call hi#('BufferActiveMod',  [theme.fg_subtle, '#2c2c2d', ''])
...
call hi#('Search',          'none',    '#28485f', 'bold')
