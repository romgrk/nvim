...
if &background == "dark"
  ...
  :exe 'hi Normal'                 .bg_white . fg_gray100
...
if &background == "dark"
  ...
  :exe 'hi mkdUrl'                .fg_blue_dark
  :exe 'hi markdownIdDeclaration'      .fg_red_med
  :exe 'hi mkdIdDeclaration'      .fg_red_med
  :exe 'hi markdownRule'               .fg_gray50
  :exe 'hi mkdRule'               .fg_gray50
endif
