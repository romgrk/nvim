...
_G.packer_plugins = {
  ...
  ["octo.nvim"] = {
    loaded = true,
    path = "/home/romgrk/.local/share/nvim/site/pack/packer/start/octo.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/romgrk/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["sidebar.nvim"] = {
    loaded = true,
    path = "/home/romgrk/.local/share/nvim/site/pack/packer/start/sidebar.nvim",
  ...
  ["ssr.nvim"] = {
    loaded = true,
    path = "/home/romgrk/.local/share/nvim/site/pack/packer/start/ssr.nvim",
...
pcall(vim.api.nvim_create_user_command, 'XtermColorTable', function(cmdargs)
          require('packer.load')({'xterm-color-table.vim'}, { cmd = 'XtermColorTable', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'xterm-color-table.vim'}, {}, _G.packer_plugins)
          return vim.fn.getcompletion('XtermColorTable ', 'cmdline')
      end})
pcall(vim.api.nvim_create_user_command, 'InteractiveWindow', function(cmdargs)
          require('packer.load')({'winteract.vim'}, { cmd = 'InteractiveWindow', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'winteract.vim'}, {}, _G.packer_plugins)
          return vim.fn.getcompletion('InteractiveWindow ', 'cmdline')
      end})
...
vim.cmd [[au FileType sass ++once lua require("packer.load")({'vim-haml', 'vim-css3-syntax'}, { ft = "sass" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'vim-haml', 'vim-css3-syntax'}, { ft = "scss" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType less ++once lua require("packer.load")({'vim-css3-syntax'}, { ft = "less" }, _G.packer_plugins)]]
vim.cmd [[au FileType dyon ++once lua require("packer.load")({'vim-dyon'}, { ft = "dyon" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'html5.vim', 'vim-liquid', 'sparkup', 'MatchTagAlways', 'html5-syntax.vim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'python-syntax', 'SimpylFold'}, { ft = "python" }, _G.packer_plugins)]]
